...
# hike that took exactly steps steps, for every step it was noted if it was an uphill, U,
# or a downhill, D step. Hikes always start and end at sea level, and each step up or
